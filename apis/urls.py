...
urlpatterns = [
    ...
    path("student_score/remove/<int:id>/", schools.StudentSubjectsScoreAPIView.as_view(), name="student_score_details_remove"),
    path("student_score/<int:id>/", schools.StudentSubjectsScoreDetailsAPIView.as_view(), name="student_score_details"),
    path("personnel/", schools.PersonnelAPIView.as_view(), name="personnel"),
    path("personnel/<str:name>/", schools.PersonnelAPIView.as_view(), name="personnel_name"),
